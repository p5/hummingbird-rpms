...
# and fastdebug variants may not be available in all repos
%ifarch %{fastdebug_arches}
...
altjavamanpage=%{top_level_dir_name}/src/java.base/share/man/%{alt_java_name}.1
altjavatext="Hardened java binary recommended for launching untrusted code from the Web e.g. javaws"
sed -r -e 's|([^/.])java([^./])|\1alt-java\2|g' %{top_level_dir_name}/src/java.base/share/man/java.1 | \
